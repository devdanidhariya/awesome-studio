...
function awesome2_sms($atts,$content=null,$shortcode){
	...
	switch($main){
		...
		if($log_messages=="on"){
			global $wpdb;
			$wpdb->query("INSERT INTO `message_log` (`message_type`, `message_provider`, `message_to`, `message_cc`, `message_bcc`, `message_from`, `message_reply_to`, `subject`, `message`) VALUES ('SMS', 'kookoo', '".$phone_no."', '', '', '', '', '', '".$message."')");			
		}			
		...
		if($log_messages=="on"){
			global $wpdb;
			$wpdb->query("INSERT INTO `message_log` (`message_type`, `message_provider`, `message_to`, `message_cc`, `message_bcc`, `message_from`, `message_reply_to`, `subject`, `message`) VALUES ('SMS', 'ozonetel', '".$phone_no."', '', '', '', '', '', '".$message."')");			
		}	
